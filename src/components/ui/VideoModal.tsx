      ...
      {activeVideo && (
        ...
        >
          <motion.div
            ...
            className="relative flex max-h-[calc(100dvh-2rem)] w-full max-w-[min(1100px,calc((100dvh-2rem)*16/9))] flex-col overflow-hidden rounded-[20px] border border-[rgba(255,255,255,0.1)] sm:max-h-[calc(100dvh-4rem)] sm:max-w-[min(1100px,calc((100dvh-4rem)*16/9))]"
            style={{
